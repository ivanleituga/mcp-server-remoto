...
<html lang="pt-BR">
  ...
  <body>
    <div class="header">
      <img src="/utils/logo-k2.png" alt="K2" style="height: 32px;" onerror="this.style.display='none'">
      <h1>K2 Sistemas</h1>
    </div>
    ...
    <div class="content">
      <div class="auth-container">
        ...
        <a href="/auth/google?client_id=${params.client_id}&redirect_uri=${encodeURIComponent(params.redirect_uri)}&scope=${params.scope || ""}&state=${params.state || ""}&response_type=${params.response_type || "code"}&code_challenge=${params.code_challenge || ""}&code_challenge_method=${params.code_challenge_method || "S256"}" class="btn-google">
